...
class ControllerExtensionModuleOptinPopup extends Controller {
	...
	public function list() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('extension/module/optin_popup/list', 'user_token=' . $this->session->data['user_token'], TRUE),
		);
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['action'] = $this->url->link('extension/module/optin_popup', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], TRUE);
		}

		$data['error_warning'] = isset($this->error['warning']) ? $this->error['warning'] : '';
		$data['success'] = isset($this->session_data['success']) ? $this->session_data['success'] : '';
		unset($this->error['warning'], $this->session->data['success']);
		...
		$this->response->setOutput($this->load->view('extension/module/optin_popup/optin_popup_list', $data));
	}
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate('add')) {
			...
			$this->response->redirect($this->url->link('extension/module/optin_popup/list', 'user_token=' . $this->session->data['user_token'], TRUE));
		}
	...
	private function getForm($popup) {
		...
		$data['cancel'] = $this->url->link('extension/module/optin_popup/list', 'user_token=' . $this->session->data['user_token'], TRUE);
